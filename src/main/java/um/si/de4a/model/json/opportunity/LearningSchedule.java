 ...
 */
package um.si.de4a.model.json.opportunity;
...
public class LearningSchedule {
    ...
    public LearningSchedule(String targetFrameworkUrl, String targetNotation, String uri, Title targetFrameworkName, Title targetName) {
